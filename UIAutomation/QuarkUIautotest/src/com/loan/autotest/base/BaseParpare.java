package com.loan.autotest.base;
...
import com.loan.autotest.utils.LogConfiguration;
import com.loan.autotest.utils.SeleniumUtil;
public class BaseParpare {
	...
	protected String testCaseSrcRoot = null;
...
//		testerName = context.getCurrentXmlTest().getParameter("testerName");
